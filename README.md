# Enterprise Network Architecture: Istanbul - Izmır WAN Design
...
Switch to **Simulation Mode** to visualize packet flow or use the command line to ping between PC terminals (e.g., from *Istanbul-Finance* to *Izmir-Logistics*).

*This project was developed for the Computer Network Systems course.*
